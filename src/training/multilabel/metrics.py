...
def f1_score(y_true, y_pred, average='micro', suffix=False,type=None):
    ...
    if type != None:
        new_true_entities = set()
        for entity in true_entities:
            if entity[0] == type:
                new_true_entities.add(entity)
        true_entities = new_true_entities

        new_pred_entities = set()
        for entity in pred_entities:
            if entity[0] == type:
                new_pred_entities.add(entity)
...
def precision_score(y_true, y_pred, average='micro', suffix=False,type=None):
...
def recall_score(y_true, y_pred, average='micro', suffix=False,type=None):
    """Compute the recall.
